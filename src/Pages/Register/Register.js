    ...
    return (
        <div className='container w-50 mx-auto border p-5 mt-5 rounded-3 bg-light'>
            ...
            <Form onSubmit={handleCreateUser}>
                ...
                <Form.Group className={agree ? 'text-primary' : 'text-danger'} controlId="formBasicCheckbox">
                    <Form.Check onClick={() => setAgree(!agree)} type="checkbox" label="Accept the terms" id='terms' />
                </Form.Group>
